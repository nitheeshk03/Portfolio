...
function Contact(){
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_5sgsunq', 'template_jtjexog', form.current, 'y4gQyygfQ7scNbPaM')
        .then((result) => {
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">nitheeshk03@gmail.com</span>
                            <a href="mailto:nitheeshk03@gmail.com" className="contact__button">Write me in 
